...
namespace ColorAmbience.DominantColorFinder
{
    ...
    internal class KCluster
    {
        ...
        internal KCluster(Color centre)
        {
            Centre = centre;
        ...
        internal void Add(Color colour)
        {
            _colours.Add(colour);
        }
        ...
        internal bool RecalculateCentre(double threshold = 0.0d)
        {
            Color updatedCentre;
        ...
        /// </summary>
        internal double DistanceFromCentre(Color colour)
        {
        ...
        /// </summary>
        internal static double EuclideanDistance(Color c1, Color c2)
        {
